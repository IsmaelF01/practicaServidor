<?php
    ...
    //funcion para encriptar el codigo
    function encriptar($mensaje, $clave){
        for($i=0; $i<strlen($mensaje); $i++){
            echo chr(ord($mensaje[$i])+$clave);//ord para pasar a codigo ASSCI chr para pasar de ASSCI a normal
        }
    }
    ...
    encriptar($_POST["mensaje"], $_POST["clave"]);
    echo "<br/>Mensaje desencriptado ";    
    desencriptar($_POST["mensaje"], $_POST["clave"]);
