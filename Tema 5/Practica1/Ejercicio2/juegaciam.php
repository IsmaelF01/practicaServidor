...
<section>
	...
	<nav class="menu">
		...
		<a href="?action=update class="menu-item blue"><img src="imgs/update.png" alt="" width="40px" style="margin-left: 60px;"></a>
		<a href="#" class="menu-item green"><img src="imgs/cargar.png" alt="" width="40px"></a>
	</nav>

</section>
<?php
$templos = $_SESSION['edificios']['templos'];
$cuarteles = $_SESSION['edificios']['cuarteles'];
$canteras = $_SESSION['edificios']['canteras'];
$aserraderos = $_SESSION['edificios']['aserraderos'];
$huertos = $_SESSION['edificios']['huertos'];
$mercados = $_SESSION['edificios']['mercados'];

echo "<p>";
echo "<span>Templos: " . $templos . "</span>&nbsp;&nbsp;&nbsp;";
echo "<span>Cuarteles: " . $cuarteles . "</span>&nbsp;&nbsp;&nbsp;";
echo "<span>Canteras: " . $canteras . "</span>&nbsp;&nbsp;&nbsp;";
echo "<span>Asseraderos: " . $aserraderos . "</span>&nbsp;&nbsp;&nbsp;";
echo "<span>Huertos: " . $huertos . "</span>&nbsp;&nbsp;&nbsp;";
echo "<span>Mercados: " . $mercados . "</span>";
echo "</p>";

addJuego($id, $oro, $madera, $comida, $marmol, $templos, $cuarteles, $canteras, $aserraderos, $huertos, $mercados);
